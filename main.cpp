...
private:
    TicTacToe board;
    int get_step_score(TicTacToe cur_board, std::tuple<int,int> coordinates, int player, int ai_player = DEFAULT_PLAYER, int current_score = 0) {
...
public:
    AIplayer(TicTacToe &current_board) : board(board) {
